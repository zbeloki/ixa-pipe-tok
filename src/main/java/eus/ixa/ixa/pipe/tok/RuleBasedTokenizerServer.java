...
public class RuleBasedTokenizerServer {
   ...
   *          the properties
   */
  public RuleBasedTokenizerServer(final Properties properties) {
    ...
    try {
      LOG.info("-> Trying to listen {}... ", port);
   ...
   */
  private String getClientData(final BufferedReader inFromClient) {
